...
const EnterToken = () => {
    ...
    const removeDivs = () => {
        ...
        else if (activeInput === 'sixth') {
            setFifthInput('')
            setActiveInput('fifth')
        }
        else if (activeInput === 'fifth') {
            setFourthInput('')
    ...
    const resetPin = () => {
        console.log(firstInput, secondInput, thirdInput, fourthInput, fifthInput, sixthInput)
        firstInput && setFirstInput('');
        secondInput && setSecondInput('');
        thirdInput && setThirdInput('');
        fourthInput && setFourthInput('');
        fifthInput && setFifthInput('');
        sixthInput && setSixthInput('');
        setActiveInput('first');
    }
